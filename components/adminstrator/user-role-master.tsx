...
const webAccessOptions = [
  ...
  { label: "14) - WH Category Master", value: "2_13"},
  { label: "15) - Warehouse Master", value: "2_14"},
  { label: "16) - WH Location Master", value: "2_15"},
  { label: "17) - Approve Job Control", value: "3_1" },
  { label: "18) - RM Label Printing", value: "3_3" },
  { label: "19) - Report", value: "5_1" },
  { label: "20) - User Master", value: "6_1" },
  { label: "21) - User Role Master", value: "6_2" },
  { label: "22) - Change Password", value: "6_3" },
  { label: "23) - Material Stock Take", value: "6_4" },
  { label: "24) - GRN Excel Upload", value: "3_2" },
];
