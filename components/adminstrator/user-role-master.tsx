...
const webAccessOptions = [
  ...
  { label: "20) - Hardware Tracking", value: "4_1" },
  { label: "21) - Hardware Tracking Reprint", value: "4_2" },
  { label: "22) - Software Tracking", value: "4_3" },
  { label: "23) - Software Tracking Reprint", value: "4_4" },
  { label: "24) - JC Report", value: "5_1" },
  { label: "25) - QC Report", value: "5_2" },
  { label: "26) - RM Inward Report", value: "5_3" },
  { label: "27) - RM Put Away Report", value: "5_4" },
  { label: "28) - RM Internal Movement Report", value: "5_5" },
  { label: "29) - Hardware Tracking Report", value: "5_6" },
  { label: "30) - Hardware RePrint Report", value: "5_7" },
  { label: "31) - Software Tracking Report", value: "5_8" },
  { label: "32) - Software Reprint Report", value: "5_9" },
  { label: "33) - Customer Feedback Report", value: "5_10" },
  { label: "34) - Customer Complaint Report", value: "5_11" },
  { label: "35) - Job Card Report", value: "5_12" },
  { label: "36) - RM Picking Report", value: "5_13" },
  { label: "37) - RM Production Material Receipt Report", value: "5_14" },
  { label: "38) - RM Production Material Return Report", value: "5_15" },
  { label: "39) - RM Warehouse Material Receipt Report", value: "5_16" },

  { label: "40) - User Master", value: "6_1" },
  { label: "41) - User Role Master", value: "6_2" },
  { label: "42) - Change Password", value: "6_3" },
  { label: "43) - Material Stock Take", value: "6_4" }
];
