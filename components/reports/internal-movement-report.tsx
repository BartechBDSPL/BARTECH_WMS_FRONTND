              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>Old Bin</TableHead>
                    <TableHead>New Bin</TableHead>
                    ...
                    paginatedData.map((row, index) => (
                      <React.Fragment key={index}>
                        <TableRow>
                          ...
                          <TableCell>{row.old_bin}</TableCell>
                          <TableCell>{row.new_bin}</TableCell>
...
export default InternalMoveMentReport;